...
RcppExport SEXP _tensorApp_CPALS_dr(SEXP T0SEXP, SEXP d0SEXP, SEXP dSEXP, SEXP dimsSEXP, SEXP D0SEXP, SEXP optsListSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< MatrixXd >::type T0(T0SEXP);
    ...
    Rcpp::traits::input_parameter< List >::type D0(D0SEXP);
    Rcpp::traits::input_parameter< List >::type optsList(optsListSEXP);
    rcpp_result_gen = Rcpp::wrap(CPALS_dr(T0, d0, d, dims, D0, optsList));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_tensorApp_CPALS_dr", (DL_FUNC) &_tensorApp_CPALS_dr, 6},
